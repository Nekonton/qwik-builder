...
export default component$(() => {
  const items = [
    [
      {
        title: 'Qwik + Builder.io Integration',
        description:
          'A seamless integration between two great software that offer high productivity, performance and versatility.',
      ...
      <div class="px-4 py-16 mx-auto max-w-6xl lg:px-8 lg:py-20">
        <div class="mb-10 md:mx-auto sm:text-center md:mb-12 max-w-3xl">
          ...
          <h2 class="text-4xl md:text-5xl font-bold leading-tighter tracking-tighter mb-4 font-heading">
            What you get with <span class="whitespace-nowrap">{SITE.name}</span>
          </h2>
